...
Version 1.4
what's new:
- modified to load datasets from the function load_func
"""
...
class DataReader(object):
    ...
    # read data from file
    def ReadData(self):
        self.XRaw, self.YRaw = self.load_func(return_X_y = True)
        self.YRaw = np.transpose([self.YRaw])
